...
export const NW_ITEM_RARITY_DATA = Object.freeze([
	...
	{
		"displayName": "@RarityLevel1_DisplayName",
		"maxPerkCount": 2
	},
	{
		"displayName": "@RarityLevel2_DisplayName",
		"maxPerkCount": 3
	},
	{
		"displayName": "@RarityLevel3_DisplayName",
		"maxPerkCount": 4
	},
	{
		"displayName": "@RarityLevel4_DisplayName",
		"maxPerkCount": 5
	}
])
...
export const NW_EQUIP_LOAD_DAMAGE_MULT_FAST = 0.15
export const NW_EQUIP_LOAD_DAMAGE_MULT_NORMAL = 0
export const NW_EQUIP_LOAD_DAMAGE_MULT_SLOW = -0.15
export const NW_EQUIP_LOAD_HEAL_MULT_FAST = 1.3
export const NW_EQUIP_LOAD_HEAL_MULT_NORMAL = 1
export const NW_EQUIP_LOAD_HEAL_MULT_SLOW = 0.7
export const NW_MAX_GEAR_SCORE = 725
export const NW_MAX_CHARACTER_LEVEL = 65
export const NW_MAX_TRADESKILL_LEVEL = 250
export const NW_MAX_CRAFT_GEAR_SCORE = 700
